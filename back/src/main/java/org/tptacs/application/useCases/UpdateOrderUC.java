...
public class UpdateOrderUC {
	...
	public void updateStatusOrder(String orderId, String userId, OrderStatus status) {
		OrderOld orderDB = orderRepository.get(orderId);
	...
	public OrderOld updateOrderForShared(String orderId, String userName){
		OrderOld orderDB = orderRepository.get(orderId);
		Optional<UserOld> userInvited = userRepository.findByUsername(userName);
